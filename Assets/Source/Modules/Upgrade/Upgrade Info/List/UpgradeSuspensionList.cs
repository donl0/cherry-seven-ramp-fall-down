...
public class UpgradeSuspensionList : UpgradeInfoList<SuspensionUpgradeDS>
{
    private List<SuspensionUpgradeDS> _acceleratios = new List<SuspensionUpgradeDS>()
    {
        ...
        new SuspensionUpgradeDS(CarType.niisan, 3000, 8),
        new SuspensionUpgradeDS(CarType.niisan, 3700, 9),
        new SuspensionUpgradeDS(CarType.niisan, 4000, 9),
        new SuspensionUpgradeDS(CarType.niisan, 4500, 10),
